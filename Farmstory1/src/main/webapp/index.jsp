...
<%
	...
	List<ArticleDTO> latests1 = dao.selectLatest("grow",5);
	List<ArticleDTO> latests2 = dao.selectLatest("school",5);
	List<ArticleDTO> latests3 = dao.selectLatest("story",5);

	List<ArticleDTO> tabLatests1 = dao.selectLatest("notice",3);
	List<ArticleDTO> tabLatests2 = dao.selectLatest("qna",3);
	List<ArticleDTO> tabLatests3 = dao.selectLatest("faq",3);
                ...
                <div>
                    <div id="tabs">
                        ...
                        <%for (ArticleDTO latest : tabLatests1){ %>
                            <ul class="txt">
                                <li><a href="/Farmstory1/board/view.jsp?group=Event&cate=notice&no=<%=latest.getNo() %>">·<%=latest.getTitle() %>.</a></li>
        					</ul>
                        <%} %>
                        </div>
                        <div id="tabs-2">
                            ...
                            <ul class="txt">
                                <li><a href="/Farmstory1/board/view.jsp?group=Event&cate=qna&no=<%=latest.getNo() %>">·<%=latest.getTitle() %>.</a></li>
                            </ul>
                        <%} %>
                        </div>
                        <div id="tabs-3">
                            ...
                            <ul class="txt">
                                <li><a href="/Farmstory1/board/view.jsp?group=Event&cate=faq&no=<%=latest.getNo() %>">·<%=latest.getTitle() %>.</a></li>
                            </ul>
                        <%} %>
                        </div>
                    </div>
