...
<html>
	 	...
	 	window.onload=function(){
	 		...
	 		btn2.addEventListener('click',function(){
	 			...
	 			.then((data)=>{
	 				...
	 				for(let user of data){//js에는 이름이 있었지만 json2에는 없으므로 배열로 함.
	 					console.log(user);
	...
	<body>
		<h3>3.JSON/XML실습하기</h3>
		
		<a href="/Ch06/data/json1.jsp">JSON1 데이터 생성</a>
		<a href="/Ch06/data/json2.jsp">JSON2 데이터 생성</a>
		<a href="/Ch06/data/xml1.jsp">xml1 데이터 생성</a>
		<a href="/Ch06/data/xml2.jsp">xml2 데이터 생성</a>
